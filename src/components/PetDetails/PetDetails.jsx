...
const PetDetails = () => {
    ...
    useEffect(() => {
        const fetchPet = async () => {
            try {
                const response = await axios.get(`https://backend-deploy-naod.onrender.com/api/pets/${id}`);
    ...
    const handleAdoptPet = async () => {
        try {
            await axios.delete(`https://backend-deploy-naod.onrender.com/api/pets/${id}`);
            navigate('/');
        } catch (error) {
    ...
    const handleLikePet = async () => {
        try {
            const response = await axios.patch(`https://backend-deploy-naod.onrender.com/api/pets/${id}/like`);
            setPet(response.data);
        } catch (error) {
